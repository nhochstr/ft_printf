...
/*   Updated: 2019/12/13 20:49:40 by nhochstr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
//  gcc -Wall -Wextra -Werror -L./libft -lft -L. -lftprintf -fsanitize=address main.c  && ./a.out
...
int main()
{
	...
	printf("%d - %d\n", j, i);
	printf("------------------------------------------------------------------------------------------------------------------\n");
	j = printf("hello ca%----4c$ %1c va %-c ??", 'a', '\n', 0);
	printf("------------\n");
	i = ft_printf("hello ca%----4c$ %1c va %-c ??", 'a', '\n', 0);
	printf("%d - %d\n", j, i);
	printf("------------------------------------------------------------------------------------------------------------------\n");
	return 0;
}
